      ...
      <Card className="w-full max-w-md">
        <CardContent className="p-8">
          <div className="flex flex-col items-center text-center">
            <svg className="h-16 w-16 text-[#1a73e8] mb-6" viewBox="0 0 24 24">
            ...
            <h1 className="text-2xl font-medium mb-2 text-[#202124]">Sign in to LetterDrive</h1>
            <p className="text-[#5f6368] mb-6">
              Create and save letters to Google Drive
            </p>
            
            <Button 
              className="flex items-center justify-center bg-[#1a73e8] hover:bg-blue-600 text-white px-6 py-5 h-auto w-full"
            ...
            <div className="mt-6 text-sm text-[#5f6368]">
              <p>By signing in, you agree to allow the app to access your Google Drive to save and retrieve letters.</p>
            </div>
          </div>
        </CardContent>
      </Card>
